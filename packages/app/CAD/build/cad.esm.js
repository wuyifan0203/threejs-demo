...
import { PerspectiveCamera, Vector3, WebGLRenderer, PCFSoftShadowMap, Scene, Group, ArrowHelper, LineSegments, BufferGeometry, LineBasicMaterial, Color, Float32BufferAttribute, EventDispatcher, MOUSE, TOUCH, Quaternion, Spherical, Vector2, Raycaster, Euler, Matrix4, Object3D, MeshBasicMaterial, CylinderGeometry, BoxGeometry, Mesh, OctahedronGeometry, Line, SphereGeometry, TorusGeometry, PlaneGeometry, DoubleSide, OrthographicCamera, ShaderMaterial, UniformsUtils, WebGLRenderTarget, Clock, GridHelper, Box3, Box3Helper } from 'three';
