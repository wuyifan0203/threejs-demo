...
function init() {
    ...
    linearFolder.add(linearControl,'x0',0,width,0.1).onChange(e=>updateLinear());
    linearFolder.add(linearControl,'y0',0,height,0.1).onChange(e=>updateLinear());
    linearFolder.add(linearControl,'x1',0,width,0.1).onChange(e=>updateLinear());
    linearFolder.add(linearControl,'y1',0,height,0.1).onChange(e=>updateLinear());

    radialFolder.add(radialControl,'x0',0,width,0.1).onChange(e=>updateRadial());
    radialFolder.add(radialControl,'y0',0,height,0.1).onChange(e=>updateRadial());
    radialFolder.add(radialControl,'x1',0,width,0.1).onChange(e=>updateRadial());
    radialFolder.add(radialControl,'y1',0,height,0.1).onChange(e=>updateRadial());
    radialFolder.add(radialControl,'r0',0,500,0.1).onChange(e=>updateRadial());
    radialFolder.add(radialControl,'r1',0,500,0.1).onChange(e=>updateRadial());
