...
function draw(scene) {
    ...
    rangeSettingFolder.add(geometryParams, 'yMin', -10, 10, 0.1).onChange(e => update());
    rangeSettingFolder.add(geometryParams, 'yMax', -10, 10, 0.1).onChange(e => update());
    ...
    settingFolder.add(controls, 'func1', getOptions()).onChange(e => update());
    settingFolder.add(controls, 'isSymmetric').onChange(e => update());
    settingFolder.add(controls, 'func2', getOptions()).onChange(e => update());

    const geometryFolder = gui.addFolder('Geometry')
    geometryFolder.add(material, 'wireframe');
    geometryFolder.add(extrudeSettings, 'steps', 1, 10, 1).onChange(e => update());
    geometryFolder.add(extrudeSettings, 'depth', 0.5, 10, 0.1).onChange(e => update());
    geometryFolder.add(extrudeSettings, 'bevelEnabled', 1, 10, 1).onChange(e => update());
    geometryFolder.add(extrudeSettings, 'bevelSize', 0, 10, 1).onChange(e => update());
    geometryFolder.add(extrudeSettings, 'bevelSegments', 1, 10, 1).onChange(e => update());
    geometryFolder.add(extrudeSettings, 'bevelOffset', 1, 10, 1).onChange(e => update());
