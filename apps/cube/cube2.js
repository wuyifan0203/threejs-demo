 ...
 * @FilePath: /threejs-demo/packages/app/cube/cube2.js
 */
...
const materials = {
  RED: getMaterial('#ff1e02'),
  ORANGE: getMaterial('#ffc12a'),
  YELLOW: getMaterial('#ffff3a'),
  WHITE: getMaterial('#ffffff'),
  GREEN: getMaterial('#00af57'),
  BLUE: getMaterial('#00afee'),
  BLACK: getMaterial('#000000'),
};
